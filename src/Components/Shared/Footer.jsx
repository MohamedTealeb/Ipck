...
export default function Footer() {
  ...
  <section>
  <footer class="relative bg-secondary text-white pt-8 pb-6">
    ...
    <div class="flex flex-wrap text-left lg:text-left">
      <div class="w-full lg:w-6/12 px-4">
        ...
        <div class="mt-6 lg:mb-0 mb-6">
          ...
          <FontAwesomeIcon icon={faFacebook} /></button><button class="text-white text-lightBlue-600 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2" type="button">
            <i className="fa-brands fa-facebook"></i></button><button class=" text-pink-400 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2" type="button">
